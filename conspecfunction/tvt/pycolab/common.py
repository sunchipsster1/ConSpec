...
DEFAULT_MAX_FRAMES_PER_PHASElong4keys = {
    'explore': 10,
    'distractor': 45,
    'explore2': 15,
    'distractor2': 45,
...
APPLE2_DISTRACTOR_GRIDverysmall = [
    '#####',
    '#xxx#',
    '#xxx#',
    '#xx+#',
...
APPLE_DISTRACTOR_GRIDverysmall = [
    'aaaaa',
    'aaaaa',
    'aaaaa',
    'aaa+a',
...
def distractor_phase(player_sprite, num_apples, max_frames,smallbig,
  ...
  if smallbig == 1:
      ...
      distractor_grid = keep_n_characters_in_grid(APPLE_DISTRACTOR_GRIDsmall, APPLE,
                                                  num_apples)
  elif smallbig == 10:
      distractor_grid = keep_n_characters_in_grid(APPLE_DISTRACTOR_GRIDverysmall, APPLE,
                                                  6)
...
def distractor_phase2(player_sprite, num_apples, max_frames,smallbig,
                     apple_reward=DEFAULT_APPLE_REWARD,
                     fix_apple_reward_in_episode=False,
                     respawn_every=DEFAULT_APPLE_RESPAWN_TIME):
  """Distractor phase engine factory.
  ...
  """
  if smallbig == 1:
      distractor_grid = keep_n_characters_in_grid(APPLE2_DISTRACTOR_GRID, APPLE2,
                                                  num_apples)
  elif smallbig == 0:
      distractor_grid = keep_n_characters_in_grid(APPLE2_DISTRACTOR_GRIDsmall, APPLE2,
                                                  num_apples)
  elif smallbig == 10:
      distractor_grid = keep_n_characters_in_grid(APPLE2_DISTRACTOR_GRIDverysmall, APPLE2,
                                                  6)
  #print(apple_reward)
  #print('apple reward')
  engine = ascii_art.ascii_art_to_game(
      ...
      drapes={
          APPLE2: ascii_art.Partial(
              AppleDrape,
              reward=apple_reward,
              fix_apple_reward_in_episode=fix_apple_reward_in_episode,
              respawn_every=respawn_every)
      },
      update_schedule=[PLAYER, APPLE2, TIMER],
      z_order=[APPLE2, PLAYER, TIMER],
  )
